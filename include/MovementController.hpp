...
DECLARE_CLASS_CODEGEN(TrickSaber, MovementController, UnityEngine::MonoBehaviour) {
    DECLARE_INSTANCE_FIELD_PRIVATE(ArrayW<Sombrero::FastVector3>, _angularVelocityBuffer);
    DECLARE_INSTANCE_FIELD_PRIVATE(int, _currentProbeIndex);
    DECLARE_INSTANCE_FIELD_PRIVATE(Sombrero::FastVector3, _prevPos);
    DECLARE_INSTANCE_FIELD_PRIVATE(Sombrero::FastQuaternion, _prevRot);

    DECLARE_INSTANCE_FIELD_PRIVATE(ArrayW<Sombrero::FastVector3>, _velocityBuffer);
    DECLARE_INSTANCE_FIELD_PRIVATE(Sombrero::FastVector3, _angularVelocity);
    DECLARE_INSTANCE_METHOD(Sombrero::FastVector3, get_angularVelocity);
    DECLARE_INSTANCE_FIELD_PRIVATE(GlobalNamespace::VRController*, _controller);
    DECLARE_INSTANCE_METHOD(GlobalNamespace::VRController*, get_controller);

    DECLARE_INSTANCE_FIELD_PRIVATE(Sombrero::FastVector3, _controllerPosition);
    DECLARE_INSTANCE_METHOD(Sombrero::FastVector3, get_controllerPosition);
    DECLARE_INSTANCE_FIELD_PRIVATE(Sombrero::FastQuaternion, _controllerRotation);
    ...
    DECLARE_INSTANCE_FIELD_PRIVATE(Sombrero::FastVector3, _velocity);
